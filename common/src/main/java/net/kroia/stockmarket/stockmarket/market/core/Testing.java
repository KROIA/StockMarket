...
public class Testing {
    ...
    private boolean marketOrderTest_1()
    {
        ...
        serverMarket.test_setCurrentMarketPrice(10);
        ...
        //Order o1 = new Order(stockmarket.getItemID(), Order.Type.LIMIT, -10, 12, 0, UUID.randomUUID(), bankAccountNr1);
        //stockmarket.putOrder(o1);
        //stockmarket.update(); // Processes Orders
        ...
        newItemBalance = bankAccount1.getBank(serverMarket.getItemID()).getTotalBalance();
    ...
    private boolean marketOrderTest_3()
    {
        ...
        newItemBalance = bankAccount2.getBank(serverMarket.getItemID()).getTotalBalance();
    ...
    private boolean mixedOrderTest_1()
    {
        ...
        newItemBalance1 = bankAccount1.getBank(serverMarket.getItemID()).getTotalBalance();
        newMoneyBalance1 = bankAccount1.getBank(moneyID).getTotalBalance();
        newItemBalance2 = bankAccount2.getBank(serverMarket.getItemID()).getTotalBalance();
