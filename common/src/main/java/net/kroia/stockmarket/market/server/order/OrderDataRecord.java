...
public class OrderDataRecord implements INetworkPayloadConverter{
    ...
    public void decode(FriendlyByteBuf friendlyByteBuf) {
        ...
        timestampSeconds = ABSOLUTE_SERVER_FIRST_STARTUP_TIME_SECONDS + (long)(friendlyByteBuf.readInt()-Integer.MIN_VALUE); // Read the timestamp as a relative time
    }
    ...
    public void encode(FriendlyByteBuf friendlyByteBuf) {
        ...
        friendlyByteBuf.writeInt((int)((timestampSeconds - ABSOLUTE_SERVER_FIRST_STARTUP_TIME_SECONDS))+Integer.MIN_VALUE); // Write the timestamp as a relative time
    }
