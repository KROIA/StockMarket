...
public class SyncBankTerminalBlockEntityPacket {
    ...
    public SyncBankTerminalBlockEntityPacket(BlockPos pos, StockMarketBlockEntity blockEntity) {
        this.pos = pos;
    ...
    public SyncBankTerminalBlockEntityPacket(FriendlyByteBuf buf) {
